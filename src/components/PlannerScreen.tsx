...
function FlightsStep({ trip, update }: { trip: Trip; update: (patch: Partial<Trip>) => void }) {
  ...
  const sortedFlights = [...availableFlights].sort((a, b) => sortMode === 'price'
    ? a.price - b.price
    : durationMinutes(a.duration) - durationMinutes(b.duration));
  useEffect(() => {
