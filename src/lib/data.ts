...
export const STAYS: StayOffer[] = [
  {
    ...
    description: '가부키초 중심에 있어 신주쿠의 쇼핑과 식당가를 도보로 둘러보기 편리한 도심형 호텔입니다.',
    rating: 8.7,
    reviews: 2431,
    price: 180000,
    total: 720000,
  ...
  },
  {
    ...
    description: '현대적인 객실과 루프톱 공간을 갖추고 있으며, 신주쿠산초메와 히가시신주쿠 사이에서 이동하기 좋은 호텔입니다.',
    rating: 8.2,
    reviews: 1180,
    price: 112000,
    total: 448000,
  ...
  },
  {
    ...
    description: '니시신주쿠 고층 빌딩가에 자리해 도쿄 전망과 조용한 휴식을 함께 즐길 수 있는 럭셔리 호텔입니다.',
    rating: 9.2,
    reviews: 3902,
    price: 480000,
    total: 1920000,
